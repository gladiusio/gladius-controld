...
func CreateSignedMessage(message *message.Message, ga *blockchain.GladiusAccountManager) (string, error) {
	...
	if err != nil {
		return "", errors.New("Error signing message, wallet likely not unlocked")
	}
